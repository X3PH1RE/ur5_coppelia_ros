...
SMOOTH_TRANSFORM_DURATION = 1.0  # Duration (seconds) for each smooth_transform call
SMOOTH_TRANSFORM_STEPS = 50      # Number of interpolation steps in smooth_transform
STAGE1_PAUSE = 0.5               # Pause time (seconds) between stage1 and stage2 in move_target
